...
<div class="payment-option" ng-show="paymentAmount === 'Bkash'">
    <i class="fab fa-paypal"></i>
    <span>Bkash</span>
</div>

<div class="payment-option" ng-show="paymentAmount === 'Nagad'">
    <i class="fab fa-google-pay"></i>
    <span>Nagad</span>
</div>

<div class="payment-option" ng-show="paymentAmount === 'Upay'">
    <i class="fab fa-phone-alt"></i>
    <span>Upay</span>
</div>

<div class="payment-option" ng-show="paymentAmount === 'Rocket'">
    <i class="fab fa-amazon-pay"></i>
    <span>Rocket</span>
</div>

<div class="payment-option" ng-show="paymentAmount === 'Nexus Pay'">
    <i class="fab fa-bhim"></i>
    <span>Nexus Pay</span>
</div>

<div class="payment-option" ng-show="paymentAmount === 'Debit Card'">
